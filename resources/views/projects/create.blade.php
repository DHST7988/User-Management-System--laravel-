...
<x-header />
    ...
    <div class="main">
        ...
        <h1 style="text-align: center;padding-top:30px;">Add New Project</h1>
        <div class="container form-container">
			<form class="form" method="post" action='{{ url("projects/create") }}' enctype="multipart/form-data"> 
			@csrf
					...
					@enderror
					<input class="form__input" type="text" placeholder="Author" name="author" required>
					@error('date')
						<span class="invalid-feedback" role="alert">
						<strong>{{ $message }}</strong>
						</span>
