...
<x-header />
    ...
    <div class="main">
        ...
        <h1 style="text-align: center;padding-top:30px;">Add New Events</h1>
        <div class="container form-container">
			<form class="form" method="post" action='{{ url("events/create") }}' enctype="multipart/form-data">
			@csrf
					...
					@enderror
					<input class="form__input" type="text" placeholder="Venue" name="venue" required>
					@error('venue')
						<span class="invalid-feedback" role="alert">
						<strong>{{ $message }}</strong>
						</span>
					...
					<button style="margin-top: 23px" class="form__button button submit" type="submit">Create</button>
                </form>
            </div>
    	</div>
	</div>
